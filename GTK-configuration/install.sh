...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Catppuccin' -KeQing-Standart)
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|catppuccin|keqing-standart|all]  (Nord/Dracula/Gruvbox/Everforest/Catppuccin/KeQing-Standart/all) ColorSchemes version
      ...
      for variant in $@; do
        case "$variant" in
          ...
          keqing-standart)
            ...
            echo -e "\KeQing-Standart ColorScheme version! ..."
            shift
            ;;
          all)
            colorscheme='true'
